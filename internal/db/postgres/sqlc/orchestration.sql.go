...
func (q *Queries) AttachOrchestrationTaskAttemptSession(ctx context.Context, arg AttachOrchestrationTaskAttemptSessionParams) (OrchestrationTaskAttempt, error) {
	row := q.db.QueryRow(ctx, attachOrchestrationTaskAttemptSession, arg.SessionID, arg.ID)
...
func (q *Queries) AttachOrchestrationTaskVerificationSession(ctx context.Context, arg AttachOrchestrationTaskVerificationSessionParams) (OrchestrationTaskVerification, error) {
	row := q.db.QueryRow(ctx, attachOrchestrationTaskVerificationSession, arg.SessionID, arg.ID)
...
func (q *Queries) CancelOrchestrationTaskVerification(ctx context.Context, arg CancelOrchestrationTaskVerificationParams) (OrchestrationTaskVerification, error) {
	row := q.db.QueryRow(ctx, cancelOrchestrationTaskVerification,
		arg.Verdict,
		arg.Summary,
		arg.FailureClass,
		arg.TerminalReason,
...
func (q *Queries) CountCompletedFinalOrchestrationTasksByRun(ctx context.Context, runID pgtype.UUID) (int64, error) {
	row := q.db.QueryRow(ctx, countCompletedFinalOrchestrationTasksByRun, runID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CountFailedOrchestrationPlanningIntentsByRun(ctx context.Context, runID pgtype.UUID) (int64, error) {
	row := q.db.QueryRow(ctx, countFailedOrchestrationPlanningIntentsByRun, runID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) GetDatabaseClockTimestamp(ctx context.Context) (interface{}, error) {
	row := q.db.QueryRow(ctx, getDatabaseClockTimestamp)
	var clock_timestamp interface{}
	err := row.Scan(&clock_timestamp)
...
func (q *Queries) HeartbeatOrchestrationTaskAttempt(ctx context.Context, arg HeartbeatOrchestrationTaskAttemptParams) (OrchestrationTaskAttempt, error) {
	row := q.db.QueryRow(ctx, heartbeatOrchestrationTaskAttempt, arg.LeaseTtlSeconds, arg.ID, arg.ClaimToken)
	var i OrchestrationTaskAttempt
	err := row.Scan(
		&i.ID,
		&i.RunID,
...
func (q *Queries) HeartbeatOrchestrationTaskVerification(ctx context.Context, arg HeartbeatOrchestrationTaskVerificationParams) (OrchestrationTaskVerification, error) {
	row := q.db.QueryRow(ctx, heartbeatOrchestrationTaskVerification, arg.LeaseTtlSeconds, arg.ID, arg.ClaimToken)
	var i OrchestrationTaskVerification
	err := row.Scan(
		&i.ID,
		&i.RunID,
...
func (q *Queries) ListCurrentOrchestrationTaskResultsByRun(ctx context.Context, runID pgtype.UUID) ([]OrchestrationTaskResult, error) {
	rows, err := q.db.Query(ctx, listCurrentOrchestrationTaskResultsByRun, runID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
WHERE tenant_id = $1
  AND owner_subject = $2
  AND COALESCE(source_metadata->>'bot_id', '') = $3::text
...
func (q *Queries) ListOrchestrationRunsByBot(ctx context.Context, arg ListOrchestrationRunsByBotParams) ([]OrchestrationRun, error) {
	rows, err := q.db.Query(ctx, listOrchestrationRunsByBot,
		arg.TenantID,
		arg.OwnerSubject,
		arg.BotID,
		arg.LimitCount,
...
func (q *Queries) ListOrchestrationWorkersByIDs(ctx context.Context, ids []string) ([]OrchestrationWorker, error) {
	rows, err := q.db.Query(ctx, listOrchestrationWorkersByIDs, ids)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListTerminalizableRunningOrchestrationRuns(ctx context.Context, limitCount int32) ([]OrchestrationRun, error) {
	rows, err := q.db.Query(ctx, listTerminalizableRunningOrchestrationRuns, limitCount)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) MarkOrchestrationHumanCheckpointCancelled(ctx context.Context, id pgtype.UUID) (OrchestrationHumanCheckpoint, error) {
	row := q.db.QueryRow(ctx, markOrchestrationHumanCheckpointCancelled, id)
	var i OrchestrationHumanCheckpoint
	err := row.Scan(
		&i.ID,
		&i.RunID,
...
func (q *Queries) MarkOrchestrationRunCancelled(ctx context.Context, arg MarkOrchestrationRunCancelledParams) (OrchestrationRun, error) {
	row := q.db.QueryRow(ctx, markOrchestrationRunCancelled, arg.TerminalReason, arg.ID)
	var i OrchestrationRun
	err := row.Scan(
		&i.ID,
		&i.TenantID,
...
func (q *Queries) MarkOrchestrationRunCancelling(ctx context.Context, id pgtype.UUID) (OrchestrationRun, error) {
	row := q.db.QueryRow(ctx, markOrchestrationRunCancelling, id)
	var i OrchestrationRun
	err := row.Scan(
		&i.ID,
		&i.TenantID,
...
func (q *Queries) MarkOrchestrationTaskAttemptParked(ctx context.Context, arg MarkOrchestrationTaskAttemptParkedParams) (OrchestrationTaskAttempt, error) {
	row := q.db.QueryRow(ctx, markOrchestrationTaskAttemptParked, arg.ParkCheckpointID, arg.ID, arg.ClaimToken)
	var i OrchestrationTaskAttempt
	err := row.Scan(
		&i.ID,
		&i.RunID,
...
func (q *Queries) MarkOrchestrationTaskCancelled(ctx context.Context, arg MarkOrchestrationTaskCancelledParams) (OrchestrationTask, error) {
	row := q.db.QueryRow(ctx, markOrchestrationTaskCancelled, arg.TerminalReason, arg.ID)
	var i OrchestrationTask
	err := row.Scan(
		&i.ID,
		&i.RunID,
...
func (q *Queries) MarkOrchestrationTaskCreatedForResume(ctx context.Context, arg MarkOrchestrationTaskCreatedForResumeParams) (OrchestrationTask, error) {
	row := q.db.QueryRow(ctx, markOrchestrationTaskCreatedForResume, arg.LatestResultID, arg.ID)
	var i OrchestrationTask
	err := row.Scan(
		&i.ID,
		&i.RunID,
...
func (q *Queries) MarkOrchestrationTaskReadyForRetry(ctx context.Context, arg MarkOrchestrationTaskReadyForRetryParams) (OrchestrationTask, error) {
	row := q.db.QueryRow(ctx, markOrchestrationTaskReadyForRetry, arg.LatestResultID, arg.ID)
	var i OrchestrationTask
	err := row.Scan(
		&i.ID,
		&i.RunID,
