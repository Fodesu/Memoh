...
func (q *Queries) GetMessageByExternalIDBySession(ctx context.Context, arg GetMessageByExternalIDBySessionParams) (GetMessageByExternalIDBySessionRow, error) {
	row := q.db.QueryRow(ctx, getMessageByExternalIDBySession, arg.ExternalMessageID, arg.SessionID)
...
func (q *Queries) GetVisibleAssistantMessageTurnForFork(ctx context.Context, arg GetVisibleAssistantMessageTurnForForkParams) (GetVisibleAssistantMessageTurnForForkRow, error) {
	row := q.db.QueryRow(ctx, getVisibleAssistantMessageTurnForFork, arg.MessageID, arg.SessionID)
...
func (q *Queries) GetVisibleUserMessageTurnForRewrite(ctx context.Context, arg GetVisibleUserMessageTurnForRewriteParams) (GetVisibleUserMessageTurnForRewriteRow, error) {
	row := q.db.QueryRow(ctx, getVisibleUserMessageTurnForRewrite, arg.MessageID, arg.SessionID)
...
func (q *Queries) ListOwnedHistoryTurnsForSessionDelete(ctx context.Context, sessionID pgtype.UUID) ([]BotHistoryTurn, error) {
	rows, err := q.db.Query(ctx, listOwnedHistoryTurnsForSessionDelete, sessionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
