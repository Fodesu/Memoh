...
type CreateBotParams struct {
	...
	CreateRequestID pgtype.Text `json:"create_request_id"`
}
...
const getBotByCreateRequest = `-- name: GetBotByCreateRequest :one
...
type GetBotByCreateRequestParams struct {
	OwnerUserID     pgtype.UUID `json:"owner_user_id"`
	CreateRequestID pgtype.Text `json:"create_request_id"`
}

type GetBotByCreateRequestRow struct {
	ID                      pgtype.UUID        `json:"id"`
	OwnerUserID             pgtype.UUID        `json:"owner_user_id"`
	Name                    string             `json:"name"`
	DisplayName             pgtype.Text        `json:"display_name"`
...
func (q *Queries) GetBotByCreateRequest(ctx context.Context, arg GetBotByCreateRequestParams) (GetBotByCreateRequestRow, error) {
	row := q.db.QueryRow(ctx, getBotByCreateRequest, arg.OwnerUserID, arg.CreateRequestID)
	var i GetBotByCreateRequestRow
	err := row.Scan(
		&i.ID,
		&i.OwnerUserID,
		&i.Name,
