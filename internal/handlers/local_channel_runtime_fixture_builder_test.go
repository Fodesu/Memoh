...
func runtimeFixtureRequestUserTurn(streamID string) *chatview.UITurn {
...
func runtimeGenerationReuseRequest(streamID, generation, text string, timestamp time.Time) *chatview.UITurn {
