...
func projectDecisionMessage(message *chatview.UIMessage, commandType, targetID, status, reason string) bool {
	if message == nil {
		return false
	}
...
func commandDecisionMessageMatches(message chatview.UIMessage, commandType, targetID string) bool {
	switch strings.TrimSpace(commandType) {
	case CommandUserInputResponse:
