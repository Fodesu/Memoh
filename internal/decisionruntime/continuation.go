...
func (r *Router) runDistributedContinuation(ctx context.Context, prepared runtimefence.PreservedDecision, commandType string, payload []byte, output chan<- application.WSStreamEvent, reconcile decisionReconciler, run continuation) error {
