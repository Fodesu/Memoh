...
const (
	...
	TaskAttemptStatusParked    = "parked"
...
const (
	...
	DefaultWorkerProfile     = "llm.default"

	// BuiltinEchoWorkerProfile is for explicit builtin_workerd fixtures.
...
const (
	CheckpointKindSemantic = "semantic"
	CheckpointKindPolicy   = "policy"
	CheckpointKindProgress = "progress"
)

const (
	CheckpointTriggeredByAgent     = "agent"
	CheckpointTriggeredByRuntime   = "runtime"
	CheckpointTriggeredByScheduler = "scheduler"
	CheckpointTriggeredByPolicy    = "policy"
)

const (
	CheckpointSeverityLow    = "low"
	CheckpointSeverityMedium = "medium"
	CheckpointSeverityHigh   = "high"
)

const (
	CheckpointReasonClarification      = "clarification"
	CheckpointReasonScopeChange        = "scope_change"
	CheckpointReasonRiskConfirmation   = "risk_confirmation"
	CheckpointReasonBlocked            = "blocked"
	CheckpointReasonBudget             = "budget"
	CheckpointReasonExternalSideEffect = "external_side_effect"
	CheckpointReasonProgressMilestone  = "progress_milestone"
	CheckpointReasonPolicyRequired     = "policy_required"
)
...
type ResumeRunResult struct {
	RunID           string   `json:"run_id"`
	LifecycleStatus string   `json:"lifecycle_status"`
	ResumedTaskIDs  []string `json:"resumed_task_ids"`
	SnapshotSeq     uint64   `json:"snapshot_seq"`
}
...
type HumanCheckpoint struct {
	...
	ResolvedResponse         string                   `json:"resolved_response,omitempty"`
