...
var (
	...
	ErrRunHintUnsupported          = errors.New("run hint is not supported by current runtime")
	...
	ErrOrchestrationIntentNotFound = errors.New("orchestration intent not found")
	ErrOrchestrationIntentInvalid  = errors.New("invalid orchestration intent payload")
