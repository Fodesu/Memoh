...
describe('resolveApiErrorMessage', () => {
  ...
  it.each([
    ...
    ['en', 'registry.skill_invalid', 'This Skill package is invalid and cannot be installed.'],
    ['zh', 'registry.skill_invalid', '该 Skill 包无效，无法安装。'],
    ['ja', 'registry.skill_invalid', 'この Skill Package は無効なため、インストールできません。'],
