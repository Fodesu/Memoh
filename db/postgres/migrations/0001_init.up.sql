...
CREATE TABLE IF NOT EXISTS tool_approval_requests (
  ...
  continuation_mode TEXT NOT NULL DEFAULT 'durable',
  ...
  CONSTRAINT tool_approval_continuation_mode_check CHECK (continuation_mode IN ('unknown', 'durable', 'local_waiter')),
