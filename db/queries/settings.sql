...
SELECT
  ...
  tts_providers.id AS tts_provider_id,
...
LEFT JOIN tts_providers ON tts_providers.id = bots.tts_provider_id
...
LEFT JOIN tts_providers ON tts_providers.id = updated.tts_provider_id
