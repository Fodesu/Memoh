...
export const getSupermarketCatalogSkillsQueryKey = (options?: Options<GetSupermarketCatalogSkillsData>) => createQueryKey('getSupermarketCatalogSkills', options);

/**
 * Search Skills across supermarket Registries
 */
export const getSupermarketCatalogSkillsQuery = defineQueryOptions<Options<GetSupermarketCatalogSkillsData>, GetSupermarketCatalogSkillsResponse, GetSupermarketCatalogSkillsError>((options?: Options<GetSupermarketCatalogSkillsData>) => ({
    key: getSupermarketCatalogSkillsQueryKey(options),
    query: async (context) => {
...
export const getSupermarketSkillImagesByDigestQueryKey = (options: Options<GetSupermarketSkillImagesByDigestData>) => createQueryKey('getSupermarketSkillImagesByDigest', options);

/**
 * Get a mirrored Skill image
 */
export const getSupermarketSkillImagesByDigestQuery = defineQueryOptions<Options<GetSupermarketSkillImagesByDigestData>, unknown, GetSupermarketSkillImagesByDigestError>((options: Options<GetSupermarketSkillImagesByDigestData>) => ({
    key: getSupermarketSkillImagesByDigestQueryKey(options),
    query: async (context) => {
        const { data } = await getSupermarketSkillImagesByDigest({
            ...options,
            ...context,
            throwOnError: true
        });
