...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/orchestration/bots/{bot_id}/runs": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/orchestration/env-resources": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.EnvResourceListPage"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Env resource payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.EnvResourceCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.EnvResourceView"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/orchestration/env-resources/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Env resource update payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.EnvResourceUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/orchestration/runs/{run_id}/blackboard/rebuild": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/orchestration.RebuildBlackboardResult"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/orchestration/runs/{run_id}/cancel": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Cancel run request",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/orchestration.CancelRunRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/orchestration.CancelRunResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/orchestration.RunInspector"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/orchestration/runs/{run_id}/tasks/{task_id}/cancel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Cancel task request",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/orchestration.CancelTaskRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/orchestration.CancelTaskResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "handlers.EnvResourceCreateRequest": {
            "type": "object",
            "required": [
                "kind",
                "name"
        ...
        "orchestration.CancelRunRequest": {
            "type": "object",
            "required": [
                "idempotency_key"
            ],
        ...
        "orchestration.CancelTaskRequest": {
            "type": "object",
            "required": [
                "idempotency_key"
            ],
        ...
        "orchestration.CancelTaskResult": {
            "type": "object",
            "properties": {
                "run_id": {
                    "type": "string"
        ...
        "orchestration.EnvPreconditions": {
            "type": "object",
            "properties": {
                "effect_class": {
                    "type": "string"
        ...
        "orchestration.InspectorAttempt": {
            "type": "object",
            "properties": {
                "attempt_no": {
                    "type": "integer"
        ...
        "orchestration.InspectorVerification": {
            "type": "object",
            "properties": {
                "attempt_no": {
                    "type": "integer"
        ...
        "orchestration.InspectorWorkerLease": {
            "type": "object",
            "properties": {
                "capabilities": {
                    "type": "object",
        ...
        "orchestration.RebuildBlackboardResult": {
            "type": "object",
            "properties": {
                "blackboard_configured": {
                    "type": "boolean"
                },
                "run_context_written": {
                    "type": "integer"
                },
                "task_results_written": {
                    "type": "integer"
                },
                "write_errors": {
                    "type": "integer"
        ...
        "orchestration.RunExecutionSpan": {
            "type": "object",
            "properties": {
                "attempt_no": {
                    "type": "integer"
        ...
        "orchestration.RunInspector": {
            ...
            "properties": {
                "action_records": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.ActionRecord"
                    }
                },
                "artifacts": {
                    "type": "array",
                ...
                "attempts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.InspectorAttempt"
                    }
                },
                "checkpoints": {
                    "type": "array",
                ...
                "dependencies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.TaskDependency"
                    }
                },
                "execution_spans": {
                    "type": "array",
                ...
                "input_manifests": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.InputManifest"
                    }
                },
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.TaskResult"
                    }
                },
                "run": {
                ...
                "stuck_signals": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.RunStuckSignal"
                    }
                },
                "summary": {
                    "$ref": "#/definitions/orchestration.RunInspectorSummary"
                },
                "tasks": {
                    "type": "array",
                    "items": {
                ...
                "timeline": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.RunTimelineEntry"
                    }
                },
                "verifications": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.InspectorVerification"
                    }
                },
                "workers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.InspectorWorkerLease"
                    }
                }
            }
        },
        "orchestration.RunInspectorSummary": {
            "type": "object",
            "required": [
                ...
                "dispatching_task_count",
                "failed_task_count",
                "open_checkpoint_count",
                "ready_task_count",
                "running_task_count",
                "stuck_signal_count",
                "verifying_task_count",
                "waiting_human_task_count"
            ],
            "properties": {
                "active_attempt_count": {
                    "type": "integer"
        ...
        "orchestration.RunListPage": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/orchestration.RunListItem"
                    }
                }
            }
        },
        ...
        "orchestration.RunTimelineEntry": {
            "type": "object",
            "properties": {
                "aggregate_id": {
                    "type": "string"
        ...
        "orchestration.Task": {
            ...
            "properties": {
                ...
                "env_preconditions": {
                    "$ref": "#/definitions/orchestration.EnvPreconditions"
                },
                "goal": {
                    "type": "string"
                },
