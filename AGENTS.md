...
- Decision routing, owner command binding, and native continuation admission live in `internal/agent/application/decision_*.go`; the shared event pump lives in `run_event_pump.go`.
